"""
URL configuration for gundam_ccs project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="Gundam CCS API",
        default_version='v1',
        description="API for Gundam Custom Collection Store - An e-commerce platform for Gundam model kits",
        terms_of_service="https://www.gundamccs.com/terms/",
        contact=openapi.Contact(email="support@gundamccs.com"),
