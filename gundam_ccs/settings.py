"""
Django settings for gundam_ccs project.
...
SECRET_KEY = config(
    'SECRET_KEY', default='django-insecure-$$ou^30(z*3-oaqq8z68rzdy$!ovc3#0-%p(-)p8n0q@cv@!a!')
...
MIDDLEWARE = [
    ...
    'gundam_ccs.middleware.APIHeadersMiddleware',
...
WSGI_APPLICATION = 'gundam_ccs.wsgi.application'
...
#         'NAME': config('DB_NAME', default='gundam_ccs_db'),
...
# Additional CORS headers for API access
CORS_ALLOW_HEADERS = [
    'accept',
    'accept-encoding',
    'authorization',
...
# Additional CORS settings for mobile/cross-origin access
...
STORE_OWNER_WHATSAPP = config(
    'STORE_OWNER_WHATSAPP', default='+584242263633')  # Your WhatsApp number

# Redis Configuration
REDIS_URL = config('REDIS_URL', default='redis://localhost:6379/0')

# Cache Configuration - Use database cache if Redis is not available
try:
    import redis
